...
const Error = () => {
  return (
    <div className="h-screen w-screen bg-emerald-100 flex items-center">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-emerald-700">
        <div className="max-w-md">
          ...
          <button className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-emerald bg-emerald-600 active:bg-emerald-600 hover:bg-emerald-700">
